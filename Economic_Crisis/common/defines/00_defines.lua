...
NGame = {
	START_DATE = "2013.11.1.1",						-- EC Edit
	...
	LAG_DAYS_FOR_LOWER_SPEED = 5,					-- EC Edit; Days of client lag for decrease of gamespeed
	LAG_DAYS_FOR_PAUSE = 10,						-- EC Edit; Days of client lag for pause of gamespeed.
...
NDiplomacy = {
	...
	MAX_OPINION_VALUE = 10000,						-- EC Edit; Max opinion value cap.
	MIN_OPINION_VALUE = -10000,						-- EC Edit; Min opinion value cap.
...
NCountry = {
	...
	VP_TO_SUPPLY_BONUS_CONVERSION = 0.5,			-- EC Edit; Bonus to supply local supplies from Victory Points, multiplied by this aspect and rounded to closest integer
	...
	NUCLEAR_PRODUCTION_SCALE = 10005000,					-- EC Edit;  +1 nuclear_production gives 1 nuke per year
	...
	MIN_WAR_SUPPORT = 0.0,
	MAX_WAR_SUPPORT = 1.0,
	FRONT_PROVINCE_SCORE = 120,    					-- EC edit; Max province score of a front. Used for the hostile troop alert
	...
	HEROES_BEING_KILLED_WAR_SUPPORT_PENALTY_SCALE = -0.03,			-- EC edit; Scaling of war heroes manpower lost to war support impact, will be added weekly as a war support penalty
	MAX_HEROES_BEING_KILLED_WEEKLY_WAR_SUPPORT_PENALTY = -0.02,		-- EC edit; Max penalty that will gained per week from war heroes manpower lost
	...
	FEMALE_UNIT_LEADER_BASE_CHANCE = {  -- EC edit;
	...
	AIR_SUPPLY_CONVERSION_SCALE = 0.07,				-- EC Edit; Conversion scale for planes to air supply
	...
	BASE_MAX_COMMAND_POWER = 500.0,					-- EC edit; base value for maximum command power
	...
	SPECIAL_FORCES_CAP_BASE = 1,					-- EC Edit; Max ammount of special forces battalions is total number of non-special forces battalions multiplied by this and modified by a country modifier
...
NResistance = {
	...
	RESISTANCE_TARGET_MODIFIER_PER_STABILITY_LOSS = 0.1,	-- EC edit; resistance target modifier per stability below 100%
...
NProduction = {
	MAX_EQUIPMENT_RESOURCES_NEED = 13, 	-- EC Edit; Max number of different strategic resources an equipment can be dependent on.
	...
	CONVOY_MAX_NAV_FACTORIES_PER_LINE = 20, -- EC Edit
	...
	CAPITULATE_FUEL_RATIO = 0.75, -- EC Edit; How much fuel will be transferred on capitulation
...
NMilitary = {
	...
	CORPS_COMMANDER_DIVISIONS_CAP = 10,			-- EC Edit; how many divisions a corps commander is limited to. 0 = inf, < 0 = blocked
	DIVISION_SIZE_FOR_XP = 8,                   -- how many battalions should a division have to count as a full divisions when calculating XP stuff
	CORPS_COMMANDER_ARMIES_CAP = 10,			-- how many armies a corps commander is limited to. 0 = inf, < 0 = blocked
	FIELD_MARSHAL_DIVISIONS_CAP = 10,			-- EC Edit; how many divisions a field marshall is limited to. 0 = inf, < 0 = blocked
	FIELD_MARSHAL_ARMIES_CAP = 10,				-- EC Edit; how many armies a field marshall is limited to. 0 = inf, < 0 = blocked
	...
	MAX_ARMY_EXPERIENCE = 600,			-- EC Edit; Max army experience a country can store
	MAX_NAVY_EXPERIENCE = 600,			-- EC Edit; Max navy experience a country can store
	MAX_AIR_EXPERIENCE = 650,				-- EC Edit; Max air experience a country can store
	...
	BASE_COMBAT_WIDTH = 1000000,                        -- EC edit; base combat width
...
NAir = {
	...
	MISSION_COMMAND_POWER_COSTS = {  -- EC Edit; command power cost per plane to create a mission
		0.0, -- AIR_SUPERIORITY
		0.0, -- CAS		
		0.0, -- INTERCEPTION	
...
NTrade = {
	DISTANCE_TRADE_FACTOR = -0.04,				-- EC edit; Trade factor is modified by distance times this
	...
	ANTI_MONOPOLY_TRADE_FACTOR_THRESHOLD = 0.9,	-- EC edit; What percentage of resources has to be sold to the buyer for the anti-monopoly factor to take effect
...
NAI = {
	...
	IRRATIONALITY_LAMBDA = 0,					-- EC edit; Lambda given to Poisson Random function determining if a leader should act a bit irrational 											
	...
	DIVISION_DESIGN_COMBAT_WIDTH_WEIGHT = -5.0,				-- EC Edit;  This score is reduced the higher width is when comparing pure changes with no target
...
NFocus = {
	FOCUS_POINT_DAYS = 1,						-- EC Edit; Each point takes a week
