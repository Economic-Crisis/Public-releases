...
static const float GB_OPACITY_NEAR = 0.3f; // Transparency when camera is near
...
static const float BORDER_FOW_REMOVAL_FACTOR = .8f; // How much of the FOW that is removed from the borders. 1.0f is no FW
